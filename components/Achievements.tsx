...
const Achievements: React.FC<AchievementsProps> = ({ user, setView }) => {
  ...
  const achievementList: Achievement[] = [
    { id: '1', title: 'Pioneiro Triuno', description: 'Realizar o Voto de Ascensão e selar o destino.', xp: 100, icon: 'history_edu', unlocked: true, progress: 1, total: 1 },
    { id: '2', title: 'Fonte da Vida', description: 'Beber 2L de água por 7 dias consecutivos.', xp: 50, icon: 'water_drop', unlocked: false, progress: 3, total: 7 },
    { id: '3', title: 'Eco de Luz', description: 'Postar 10 mensagens de gratidão no Rio.', xp: 80, icon: 'auto_awesome', unlocked: false, progress: 4, total: 10 },
    { id: '4', title: 'Sincronia Perfeita', description: 'Conectar-se com 5 novos buscadores.', xp: 120, icon: 'sync', unlocked: false, progress: (user.connections?.length || 0), total: 5 },
    { id: '5', title: 'Mente Serena', description: 'Completar 20 missões do vetor Espírito.', xp: 150, icon: 'self_improvement', unlocked: false, progress: 8, total: 20 },
    { id: '6', title: 'Corpo Templo', description: 'Completar 15 missões do vetor Corpo.', xp: 100, icon: 'fitness_center', unlocked: false, progress: 6, total: 15 },
  ];
